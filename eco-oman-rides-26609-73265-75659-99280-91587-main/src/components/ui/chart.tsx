...
interface ChartTooltipContentProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  label?: React.ReactNode;
  labelFormatter?: (value: React.ReactNode, items: TooltipPayloadItem[]) => React.ReactNode;
              ...
              >
                  ...
                  <>
                    ...
                    >
                      <div className="grid gap-1.5">
                        {nestLabel ? tooltipLabel : null}
                        <span className="text-muted-foreground">{String(itemConfig?.label || item.name || "")}</span>
                      </div>
                      {item.value && (
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: TooltipPayloadItem | LegendPayloadItem, key: string) {
